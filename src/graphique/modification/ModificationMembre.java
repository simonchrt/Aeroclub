...
public class ModificationMembre {
    ...
    public ModificationMembre() {
        JFrame fenetreModificationMembre = new JFrame("Modifier un membre");
        fenetreModificationMembre.setLayout(null);
        ...
        fenetreModificationMembre.add(numMembre);
        fenetreModificationMembre.add(court);
        fenetreModificationMembre.add(numQualif);
        fenetreModificationMembre.add(numCompte);
        fenetreModificationMembre.add(nom);
        fenetreModificationMembre.add(prenom);
        fenetreModificationMembre.add(adresse);
        fenetreModificationMembre.add(codePostal);
        fenetreModificationMembre.add(ville);
        fenetreModificationMembre.add(tel);
        fenetreModificationMembre.add(email);
        fenetreModificationMembre.add(numBadge);
        fenetreModificationMembre.add(profession);
        fenetreModificationMembre.add(dateNaissance);
        fenetreModificationMembre.add(lieuNaissance);
        fenetreModificationMembre.add(dateEntree);

        fenetreModificationMembre.add(formNumMembre);
        fenetreModificationMembre.add(formCourt);
        fenetreModificationMembre.add(formNumQualif);
        fenetreModificationMembre.add(formNumCompte);
        fenetreModificationMembre.add(formNom);
        fenetreModificationMembre.add(formPrenom);
        fenetreModificationMembre.add(formAdresse);
        fenetreModificationMembre.add(formCodePostal);
        fenetreModificationMembre.add(formVille);
        fenetreModificationMembre.add(formTel);
        fenetreModificationMembre.add(formEmail);
        fenetreModificationMembre.add(formNumBadge);
        fenetreModificationMembre.add(formProfession);
        fenetreModificationMembre.add(formDateNaissance);
        fenetreModificationMembre.add(formLieuNaissance);
        fenetreModificationMembre.add(formDateEntree);
        fenetreModificationMembre.add(boutonModification);
        fenetreModificationMembre.add(boutonEffacer);
        fenetreModificationMembre.add(boutonRetour);
        ...
        boutonModification.setBounds(120, 685, 100, 30);
        boutonEffacer.setBounds(320, 685, 100, 30);
        boutonRetour.setBounds(520, 685, 100, 30);

        fenetreModificationMembre.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        fenetreModificationMembre.setResizable(true);
        fenetreModificationMembre.setSize(750, 750);
        fenetreModificationMembre.setLocationRelativeTo(null);
        fenetreModificationMembre.setVisible(true);
        ...
        boutonModification.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    Logger.getLogger(ModificationMembre.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
        ...
        boutonRetour.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                fenetreModificationMembre.setVisible(false);
                new Choix();
            }
        });
    }
